function getDataCairns(){
    ...
    document.getElementById("detail-page__city-description").innerHTML = "<p> La ciudad recibe su nombre de William Wellington Cairns, antiguo gobernador de Queensland y fundador de la ciudad. Se formó para servir a los mineros que iban en dirección a la mina de oro del río Hodgkinson, pero experimentó un retroceso en su desarrollo por el descubrimiento de una ruta más fácil por Port Douglas.</p> <p> <br> Más tarde se convirtió en un puerto importante para la exportación de caña de azúcar, oro, metales, minerales y productos agrícolas de los alrededores y las zonas costeras de la región de la meseta Atherton. </p>";
...
function getDataFraserIsland(){
    ...
    document.getElementById("detail-page__city-description").innerHTML = "<p> La isla Fraser, K'Gari en el idioma batjala, es la isla de arena más grande del mundo con 1630 km². Fue inscrita como Patrimonio de la Humanidad por la Unesco en el año 1992. Está bajo la administración tanto de la ciudad de Maryborough como de la ciudad de Hervey Bay City Council. </p> <p> <br> Para los aborígenes, la llegada de colonos europeos fue un auténtico desastre. No se encuentra ninguno hoy día. Los primeros habitantes de la Isla Fraser fueron el pueblo Butchulla. Investigación arqueológicas han demostrado que vivieron allí desde hacía más de 5.000 años, pero nuevas investigaciones podrían hacer remontarse la ocupación de la isla a tiempos más antiguos todavía. Hoy en día, las trampas para los peces, los restos de fogatas, las huellas dejadas en los troncos de árboles o los residuos (principalmente de conchas) son testimonio de la presencia de estos primeros habitantes. </p>";
    document.getElementById("detail-page__whattodo-par-one").innerHTML = "Ha sido un viaje divertido lleno de personajes divertidos, corazones acelerados e historias que se contarán en las próximas décadas. Cada día es tan emocionante como el día que comenzamos. Y no hay nada en lo que prefiramos gastar nuestro tiempo. ";
}
